...
|------|-------------|------|---------|:--------:|
| <a name="input_chart"></a> [chart](#input\_chart) | Chart of helm release | `string` | `"aws-for-fluent-bit"` | no |
...
| <a name="input_name"></a> [name](#input\_name) | Name of helm release | `string` | `"aws-for-fluent-bit"` | no |
| <a name="input_namespace"></a> [namespace](#input\_namespace) | namespace of helm release | `string` | `"logging"` | no |
